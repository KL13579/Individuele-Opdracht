...
Voorspelling_best = Totaal_per_land.append(Voorspelling_hoog)
Voorspelling_average = Totaal_per_land.append(Voorspelling_basis)
Voorspelling_worst = Totaal_per_land.append(Voorspelling_laag)
...
#Code voor de plots over de voorspelling per land
    fig = px.line(Voorspelling_best, x = "YEAR", y = land_variabele, 
                      title = "Totaal ATM's per Jaar op '" + land_variabele + "' (Beste scenario)", 
                 width=800, height=400)
    fig.update_xaxes(title = "Tijd (Jaren)")
    fig.update_yaxes(title = "Aantal ATM's")
    st.plotly_chart(fig)
    
    fig1 = px.line(Voorspelling_average, x = "YEAR", y = land_variabele,
               title = "Totaal ATM's per Jaar op '" + land_variabele + "' (Gemiddeld scenario)", width=800, height=400)
    fig1.update_xaxes(title = "Tijd (Jaren)")
    fig1.update_yaxes(title = "Aantal ATM's")
    st.plotly_chart(fig1)
    
    fig2 = px.line(Voorspelling_worst, x = "YEAR", y = land_variabele,
                   title = "Totaal ATM's per Jaar op '" + land_variabele + "' (Slechtste scenario)", width=800, height=400)
    fig2.update_xaxes(title = "Tijd (Jaren)")
    fig2.update_yaxes(title = "Aantal ATM's")
