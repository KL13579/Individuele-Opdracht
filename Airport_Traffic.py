...
#Selecteren van de benodigde kolommen
    #df_eurocontrol5 = df_eurocontrol4[["Land", 2023.0, 2024.0, 2025.0, 2026.0, 2027.0, "Scenario"]]
...
#Code voor de plots over de voorspelling per land
    ...
    fig1 = px.line(Voorspelling_average, x = "YEAR", y = land_variabele, 
                      title = "Totaal ATM's per Jaar op '" + land_variabele + "' (Gemiddeld scenario)")
    fig.update_xaxes(title = "Tijd (Jaren)")
    fig.update_yaxes(title = "Aantal ATM's")
    st.plotly_chart(fig1)
    
    fig2 = px.line(Voorspelling_worst, x = "YEAR", y = land_variabele, 
                      title = "Totaal ATM's per Jaar op '" + land_variabele + "' (Slechtste scenario)")
    fig.update_xaxes(title = "Tijd (Jaren)")
    fig.update_yaxes(title = "Aantal ATM's")
