...
with tab1:
    ...
    st.write("In dit tabblad wordt er laten zien wa het aantal ATM's is wereldwijd over de afgelopen jaren. En waarom er een eventuele daling/stijging in zat. Onderzoek laat zien dat er in 2020 50% minder vluchten werden uitgevoerd ten opzichte van 2019 en er een gezamelijk verlies van €372 miljard werd gedraaid (alle airlines bij elkaar).")
